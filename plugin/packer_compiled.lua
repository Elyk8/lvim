...
vim.cmd [[au BufWinEnter * ++once lua require("packer.load")({'barbar.nvim', 'dashboard-nvim', 'nvim-toggleterm.lua', 'which-key.nvim', 'galaxyline.nvim'}, { event = "BufWinEnter *" }, _G.packer_plugins)]]
...
vim.cmd [[au BufRead * ++once lua require("packer.load")({'nvim-comment', 'nvim-lastplace', 'vimtex', 'gitsigns.nvim'}, { event = "BufRead *" }, _G.packer_plugins)]]
