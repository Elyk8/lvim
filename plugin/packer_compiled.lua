...
_G.packer_plugins = {
  ...
  ["vim-rooter"] = {
    ...
    loaded = false,
    needs_bufread = false,
    path = "/home/kyle/.local/share/lunarvim/site/pack/packer/opt/vim-rooter"
  },
  ["vim-vsnip"] = {
    loaded = false,
    needs_bufread = false,
...
vim.cmd [[au BufRead * ++once lua require("packer.load")({'vimtex', 'nvim-comment', 'nvim-lastplace', 'gitsigns.nvim'}, { event = "BufRead *" }, _G.packer_plugins)]]
vim.cmd [[au BufReadPre * ++once lua require("packer.load")({'vim-rooter', 'nvim-colorizer.lua'}, { event = "BufReadPre *" }, _G.packer_plugins)]]
