...
vim.cmd [[au BufRead * ++once lua require("packer.load")({'nvim-lastplace', 'diffview.nvim', 'vimtex', 'nvim-colorizer.lua', 'nvim-comment', 'gitsigns.nvim'}, { event = "BufRead *" }, _G.packer_plugins)]]
