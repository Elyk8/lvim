...
vim.cmd [[au BufRead * ++once lua require("packer.load")({'nvim-colorizer.lua', 'vimtex', 'nvim-comment', 'diffview.nvim', 'nvim-lastplace', 'gitsigns.nvim'}, { event = "BufRead *" }, _G.packer_plugins)]]
