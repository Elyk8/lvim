...
vim.cmd [[au BufRead * ++once lua require("packer.load")({'diffview.nvim', 'vimtex', 'nvim-colorizer.lua', 'nvim-comment', 'nvim-lastplace', 'gitsigns.nvim'}, { event = "BufRead *" }, _G.packer_plugins)]]
