...
_G.packer_plugins = {
  ...
  ["nvim-colorizer.lua"] = {
    config = { "\27LJ\2\n³\1\0\0\4\0\b\0\f6\0\0\0'\2\1\0B\0\2\0029\0\2\0005\2\3\0005\3\4\0B\0\3\0016\0\5\0009\0\6\0'\2\a\0B\0\2\1K\0\1\0\30ColorizerReloadAllBuffers\bcmd\bvim\1\0\a\bcss\2\vcss_fn\2\vhsl_fn\2\vrgb_fn\2\rRRGGBBAA\2\vRRGGBB\2\bRGB\2\1\3\0\0\6*\t!vim\nsetup\14colorizer\frequire\0" },
    loaded = false,
    needs_bufread = false,
...
vim.cmd [[au BufWinEnter * ++once lua require("packer.load")({'nvim-toggleterm.lua', 'dashboard-nvim', 'galaxyline.nvim', 'which-key.nvim', 'barbar.nvim'}, { event = "BufWinEnter *" }, _G.packer_plugins)]]
...
vim.cmd [[au BufRead * ++once lua require("packer.load")({'vimtex', 'diffview.nvim', 'nvim-lastplace', 'gitsigns.nvim', 'nvim-colorizer.lua', 'nvim-comment'}, { event = "BufRead *" }, _G.packer_plugins)]]
